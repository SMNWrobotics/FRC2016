...
//        autonomousCommand = new AutonomousCommand();
        ...
        autoChooser.addDefault("Do nothing" , new AutCommDoNothing() );
        autoChooser.addObject("Do Something" , new AutCommGoForward() );
        autoChooser.addObject("Do something else" , new AutCommGoBackward() );
