...
public class Roller extends Subsystem {
	...
	public void toggleMotor(double speed) {
		if (rollerMotor.get() != 0) { //if rollerMotor is running (it's speed doesn't = 0),
			rollerMotor.set(0); //turn it off
		} else { //otherwise:
			rollerMotor.set(speed); //run it at this speed (may need to switch to negative and positive?)
		}
	}
}
